...
def test_trackio_space_examples_use_hyphenated_aidd_intern_prefix():
    ...
    assert "<username>/aidd-intern-<8-char-id>" in prompt
    assert "<username>/aidd-intern-<8char>" in tool_specs
