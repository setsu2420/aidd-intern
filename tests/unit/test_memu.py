...
@patch("agent.core.memu.httpx.Client")
def test_memu_retrieve_fallback_on_network_failure(
    mock_client_class, tmp_path, monkeypatch
):
    from agent.core import memu
...
@pytest.mark.asyncio
@patch("agent.core.memu.httpx.AsyncClient")
async def test_memu_aretrieve_fallback_on_network_failure(
    mock_aclient_class, tmp_path, monkeypatch
):
    from agent.core import memu
